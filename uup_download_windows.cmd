@echo off
:: Generated on 2025-04-04 16:20:25 GMT
...
:START_PROCESS
title 26100.3624_amd64_zh-cn_professional_76a03c5b download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=76a03c5b-7ea2-4a7d-9948-8081b90edcd4&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
